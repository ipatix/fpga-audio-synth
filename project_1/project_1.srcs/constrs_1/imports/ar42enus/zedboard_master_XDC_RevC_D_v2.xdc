...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W7 [get_ports {uart_in}];  # "JD1_N"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {gpo[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {gpo[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {gpo[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {gpo[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {gpo[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {gpo[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {gpo[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {gpo[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {gpi[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {gpi[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {gpi[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {gpi[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {gpi[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {gpi[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {gpi[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {gpi[7]}];  # "SW7"
