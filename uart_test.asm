...
sb $zero, MIDI_STATE_BEND_RANGE(%chn_ptr)
...
main:
    ...
    nop
    sb $t1, (R_GPIO)
    i_bne($t2, $zero, reset_mem)
    i_lw($t0, R_UART_INTERFACE, UART_INTERFACE_DATA_READY)
    i_beq($t0, $zero, main)
    i_lb($t0, R_UART_INTERFACE, UART_INTERFACE_DATA)
    nop
    nop
    sb $t0, ($t7)
    addi $t7, $t7, 1
